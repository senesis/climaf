...
project = u'CliMAF'
copyright = u'2014, Météo-France / IPSL / CNRS - Under a (GNU GPL-compatible) CeCILL-C licence'
...
latex_documents = [
    ('index', 'CliMAF.tex', u'CliMAF Documentation',
...
man_pages = [
    ('index', 'climaf', u'CliMAF Documentation',
     [u'Stéphane Sénési'], 1)
]
...
texinfo_documents = [
    ('index', 'CliMAF', u'CliMAF Documentation',
     u'Stéphane Sénési', 'CliMAF', 'One line description of project.',
     'Miscellaneous'),
]
...
epub_title = u'CliMAF'
epub_author = u'Stéphane Sénési'
epub_publisher = u'Stéphane Sénési'
epub_copyright = u'2014, Stéphane Sénési'

# The basename for the epub file. It defaults to the project name.
# epub_basename = u'CliMAF'

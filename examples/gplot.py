...
plot_map5 = plot(tas, sub_tas, uas, vas,
...
#
# This example will work on CNRM's Lustre. An only new feature is added: ROTATION of VECTORS from model grid on
# geographic grid
#
if atCNRM:
    ...
    # geographic grid
    plot_map4b = plot(tos, sub_tos, duo, dvo,
...
plot_cross5 = plot(ta_zonal_mean, ta_zonal_mean2, contours="240 245 250",
...
plot_cross6 = plot(ta_zonal_mean, ta_zonal_mean2, y="lin",

...
#    * ccdfmean_profile_box : vertical profile of horizontal means for 3D fields on a given geographical domain
#    (output: excluded mean value)
...
if not atCNRM:
    exit(0)
if 'ccdfmean' not in get_variable("scripts"):
...
fixed_fields(['ccdfzonalmean_bas'],
             ...
             ('mesh_zgr.nc', tpath + 'ORCA1_mesh_zgr.nc'),
             ('new_maskglo.nc',
              '/cnrm/ioga/Users/chevallier/chevalli/Monitoring/MONITORING_v3.1/config/ORCA1_new_maskglo.nc'))
...
# along a section made of Nsec linear segments
my_cdfsections = ccdfsectionsm(dso, dtho, dmld, duo, dvo, larf=48.0, lorf=125.0, Nsec=1, lat1=50.0, lon1=127.0,
                               lat2=50.5, lon2=157.5, n1=20)
...
my_cdfsections2 = ccdfsectionsm(dso, dtho, dmld, duo, dvo, larf=48.0, lorf=305.0, Nsec=2, lat1=49.0, lon1=307.0,
                                lat2=50.5, lon2=337.5, n1=20, more_points='40.3 305.1 50')

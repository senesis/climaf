...
dict_plot_params = {
    ...
    'gpptot': {
        ...
        'full_field': {'colors': '50 100 250 500 750 1000 1250 1500 1750 2000 2250 2500 2750 3000 3250 3500',
                       'color': 'precip3_16lev'},
    ...
    'GPP_treeFracPrimEver': {
        'default': {'color': 'precip3_16lev', 'units': 'gC.m-2.yr-1', 'scale': 365. * 86400. * 1000.},
        'full_field': {'colors': '50 100 250 500 750 1000 1250 1500 1750 2000 2250 2500 2750 3000',
                       'color': 'precip3_16lev'},
        'bias': {'min': -1000., 'max': 1000, 'delta': 100, 'color': 'ViBlGrWhYeOrRe'},
        'model_model': {'min': -500., 'max': 500, 'delta': 50, 'color': 'ViBlGrWhYeOrRe'},
    },
    ...
    'GPP_c4PftFrac': {
        'default': {'color': 'precip3_16lev', 'units': 'gC.m-2.yr-1', 'scale': 365. * 86400. * 1000.},
        'full_field': {'colors': '10 50 100 150 200 250 300 350 400 450 500 550 600 700 800 900 1000 1100',
                       'color': 'precip3_16lev'},
        'bias': {'min': -1000., 'max': 1000, 'delta': 100, 'color': 'ViBlGrWhYeOrRe'},
        'model_model': {'min': -500., 'max': 500, 'delta': 50, 'color': 'ViBlGrWhYeOrRe'},
    },

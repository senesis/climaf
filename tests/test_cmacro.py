...
class CrewriteTests(unittest.TestCase):
    ...
    def test_crewrite(self):
        ...
        self.assertEqual(new_crstest_1,
                         "plot(ccdo(llbox(ds('toto|AMIPV6ALB2G|ta|198001|global|monthly'),latmax=60,latmin=40,"
                         "lonmax=25,lonmin=-15),operator='zonmean'))")
        crstest_2 = "plot(ccdo(llbox(ds('example|AMIPV6ALB2G|ta|198001|global|monthly'),latmax=60,latmin=40,lonmax=25,"\
                    "lonmin=-15),operator='zonmean'))"
        ...
        macro('eu_cross_section', fig_ezm, [january_ta2, ])
...
class ReadWriteTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        mean_january_ta = time_average(january_ta)
        my_bias = minus(january_ta, mean_january_ta)
        macro("my_bias", my_bias, [mean_january_ta, ])

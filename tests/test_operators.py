...
from climaf.operators_derive import derived_variable, derive, is_derived_variable
...
class CscriptTest(unittest.TestCase):
    ...
    def test_existing_function(self):
        ...
        cscript("tmp_directory", "cdo ${operator} ${in} ${out}")
    ...
    def test_unexisting_function(self):
        with self.assertRaises(Climaf_Operator_Error):
            cscript('mycdo', 'mycdo ${operator} ${in} ${out}')
...
class FixedFieldsTest(unittest.TestCase):
    ...
    def test_fixed_fields(self):
        ...
        from climaf.environment import scripts
...
class DeriveTest(unittest.TestCase):
    ...
    def test_derive_from_script(self):
        ...
        from climaf.environment import derived_variables
